...
if __name__ == "__main__":
    ...
    cv.imwrite('../photo_rectangle_2/test_1.jpg', ttt_1)
    cv.imwrite('../photo_rectangle_2/test_2.jpg', ttt_2)
    cv.imwrite('../photo_rectangle_2/test_3.jpg', ttt_3)
    cv.imwrite('../photo_rectangle_2/test_4.jpg', ttt_4)
